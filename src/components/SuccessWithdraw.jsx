...
import { getSuccessWithdrawals } from "../utils/apiService";
...
const SuccessWithdraw = () => {
  ...
  const fetchWithdrawals = async () => {
    setIsLoading(true);
    try {
      const data = await getSuccessWithdrawals({
      ...
      <div className="card-body py-8">
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600">
            Showing {withdrawals.length} of {pagination.total} results (Page{" "}
          ...
          <table className="table bordered-table text-sm w-full">
            <thead>
              <tr>
                ...
                <th>Sender Gateway</th>
                <th>Success Date & Time</th>
